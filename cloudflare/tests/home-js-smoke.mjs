...
assert.match(fragments.homeModalsScript, /reviewQueueSummary/);
assert.match(fragments.homeModalsScript, /imageLinkCount/);
assert.match(fragments.homeModalsScript, /admin-review-card-changes/);
